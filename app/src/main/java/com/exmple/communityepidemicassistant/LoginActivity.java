...
import com.exmple.communityepidemicassistant.user.User;
import com.exmple.communityepidemicassistant.user.UserDBOpenHelper;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserDBOpenHelper.add("锦江学院","123456");
